...
const acc = {
    editar: 'ADMINISTRACION_PROCESO_ESTADO_EDITAR',
    mostrar: 'ADMINISTRACION_PROCESO_ESTADO_MOSTRAR',
    borrar: 'ADMINISTRACION_PROCESO_ESTADO_BORRAR',
};
const permisoAny = 'ADMINISTRACION_PROCESO_ESTADO_';
// Permisos requeridos por la interfaz
const permisos = {
    listado: 'MENU_ADMINISTRACION_PROCESO_ESTADO',
    crear: 'ADMINISTRACION_PROCESO_ESTADO_CREAR',
    exportar: 'ADMINISTRACION_PROCESO_ESTADO_EXPORTAR',
