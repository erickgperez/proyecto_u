...
const acc = {
    editar: 'ACADEMICA_PLAN_ESTUDIO_CARRERA_EDITAR',
    mostrar: 'ACADEMICA_PLAN_ESTUDIO_CARRERA_MOSTRAR',
    borrar: 'ACADEMICA_PLAN_ESTUDIO_CARRERA_BORRAR',
};
// Permisos requeridos por la interfaz
const permisos = {
    listado: 'MENU_ACADEMICA_PLAN_ESTUDIO_CARRERA',
    crear: 'ACADEMICA_PLAN_ESTUDIO_CARRERA_CREAR',
    exportar: 'ACADEMICA_PLAN_ESTUDIO_CARRERA_EXPORTAR',
