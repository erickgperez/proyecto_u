...
import FormaImparteForm from '@/components/academico/FormaImparteForm.vue';
import FormaImparteShow from '@/components/academico/FormaImparteShow.vue';
...
const rutaBorrar = ref('academico-formaImparte-delete');
const mensajes = {
    titulo1: t('formaImparte._plural_'),
    titulo2: t('formaImparte._administrar_'),
    subtitulo: t('formaImparte._permite_gestionar_'),
    tituloListado: t('formaImparte._listado_'),
};

//Acciones que se pueden realizar al seleccionar un registro
const acc = {
    editar: 'ACADEMICO_FORMA-IMPARTE_EDITAR',
    mostrar: 'ACADEMICO_FORMA-IMPARTE_MOSTRAR',
    borrar: 'ACADEMICO_FORMA-IMPARTE_BORRAR',
};
const permisoAny = 'ACADEMICO_FORMA-IMPARTE_';
// Permisos requeridos por la interfaz
const permisos = {
    listado: 'MENU_ACADEMICO_FORMA-IMPARTE',
    crear: 'ACADEMICO_FORMA-IMPARTE_CREAR',
    exportar: 'ACADEMICO_FORMA-IMPARTE_EXPORTAR',
...
const sheetName = ref('Listado_formaImparte');
const fileName = ref('formaImparte');
            ...
            <v-window v-model="step" class="h-auto w-100">
                ...
                <v-window-item :value="3">
                    <v-sheet v-if="step === 3" class="bg-transparent">
                        ...
                        ></FormaImparteForm>
                        <FormaImparteShow v-if="selectedAction == 'show'" :item="selectedItem" :accion="selectedAction"></FormaImparteShow>
                    </v-sheet>
                </v-window-item>
            </v-window>
