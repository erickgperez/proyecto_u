...
const acc = {
    editar: 'ACADEMICO_PLAN-ESTUDIO_CARRERA_EDITAR',
    mostrar: 'ACADEMICO_PLAN-ESTUDIO_CARRERA_MOSTRAR',
    borrar: 'ACADEMICO_PLAN-ESTUDIO_CARRERA_BORRAR',
};
const permisoAny = 'ACADEMICO_PLAN-ESTUDIO_CARRERA_';
// Permisos requeridos por la interfaz
const permisos = {
    listado: 'MENU_ACADEMICO_PLAN-ESTUDIO_CARRERA',
    crear: 'ACADEMICO_PLAN-ESTUDIO_CARRERA_CREAR',
    exportar: 'ACADEMICO_PLAN-ESTUDIO_CARRERA_EXPORTAR',
