...
import UsoEstadoForm from '@/components/academico/UsoEstadoForm.vue';
import UsoEstadoShow from '@/components/academico/UsoEstadoShow.vue';
...
const rutaBorrar = ref('academico-tipo_curso-delete');
const mensajes = {
    titulo1: t('usoEstado._plural_'),
    titulo2: t('usoEstado._administrar_'),
    subtitulo: t('usoEstado._permite_gestionar_'),
    tituloListado: t('usoEstado._listado_'),
};

//Acciones que se pueden realizar al seleccionar un registro
const acc = {
    editar: 'ACADEMICO_USO-ESTADO_EDITAR',
    mostrar: 'ACADEMICO_USO-ESTADO_MOSTRAR',
    borrar: 'ACADEMICO_USO-ESTADO_BORRAR',
};
const permisoAny = 'ACADEMICO_USO-ESTADO_';
// Permisos requeridos por la interfaz
const permisos = {
    listado: 'MENU_ACADEMICO_USO-ESTADO',
    crear: 'ACADEMICO_USO-ESTADO_CREAR',
    exportar: 'ACADEMICO_USO-ESTADO_EXPORTAR',
...
const sheetName = ref('Listado_usos_estado');
const fileName = ref('usos_estados');
...
<template>
    ...
    ************************************************************************************
    ...
    <AppLayout :titulo="mensajes.titulo2" :subtitulo="mensajes.subtitulo" icono="mdi-distribute-vertical-center">
            ...
            <v-window v-model="step" class="h-auto w-100">
                ...
                <v-window-item :value="3">
                    <v-sheet v-if="step === 3">
                        ...
                        ></UsoEstadoForm>
                        <UsoEstadoShow v-if="selectedAction == 'show'" :item="selectedItem" :accion="selectedAction"></UsoEstadoShow>
                    </v-sheet>
                </v-window-item>
            </v-window>
