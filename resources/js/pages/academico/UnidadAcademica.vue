...
import UnidadAcademicaForm from '@/components/academico/UnidadAcademicaForm.vue';
import UnidadAcademicaShow from '@/components/academico/UnidadAcademicaShow.vue';
...
const rutaBorrar = ref('academico-plan_estudio-unidad_academica-delete');
const mensajes = {
...
<template>
    ...
    ************************************************************************************
    ...
    <AppLayout :titulo="mensajes.titulo2" :subtitulo="mensajes.subtitulo" icono="mdi-notebook-edit-outline">
