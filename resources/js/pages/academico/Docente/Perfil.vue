...
import { Docente, Persona, Sexo } from '@/types/tipos';
...
const props = defineProps({
    docente: {
        type: Object as PropType<Docente>,
        required: true,
    },
    persona: {
...
<template>
    <Head :title="$t('docente._perfil_')"></Head>
    <AppLayout :titulo="$t('docente._perfil_')" :subtitulo="$t('docente._perfil_descripcion_')" icono="mdi-card-account-details-outline">
        <v-card>
            ...
            <v-tabs-window v-model="tab">
                <v-tabs-window-item :value="1">
                    <v-container fluid>
                        <PerfilForm :item="props.persona" perfil="docente" accion="edit" :sexos="props.sexos"></PerfilForm>
                    </v-container>
                </v-tabs-window-item>
                ...
                <v-tabs-window-item :value="3">
                    <v-container fluid>
                        <PerfilDocumentos :item="props.persona" perfil="docente" accion="edit" :tipos-documento="tiposDocumento"></PerfilDocumentos>
                    </v-container>
                </v-tabs-window-item>
            </v-tabs-window>
        </v-card>
