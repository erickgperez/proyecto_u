...
import TipoCursoForm from '@/components/academico/TipoCursoForm.vue';
import TipoCursoShow from '@/components/academico/TipoCursoShow.vue';
...
const mensajes = {
    titulo1: t('tipoCurso._plural_'),
    titulo2: t('tipoCurso._administrar_'),
    subtitulo: t('tipoCurso._permite_gestionar_'),
    tituloListado: t('tipoCurso._listado_'),
};

//Acciones que se pueden realizar al seleccionar un registro
const acc = {
    editar: 'ACADEMICO_TIPO-CURSO_EDITAR',
    mostrar: 'ACADEMICO_TIPO-CURSO_MOSTRAR',
    borrar: 'ACADEMICO_TIPO-CURSO_BORRAR',
};
const permisoAny = 'ACADEMICO_TIPO-CURSO_';
// Permisos requeridos por la interfaz
const permisos = {
    listado: 'MENU_ACADEMICO_TIPO-CURSO',
    crear: 'ACADEMICO_TIPO-CURSO_CREAR',
    exportar: 'ACADEMICO_TIPO-CURSO_EXPORTAR',
...
const sheetName = ref('Listado_tipos_curso');
const fileName = ref('tipos_curso');
...
<template>
    ...
    ************************************************************************************
    ...
    <AppLayout :titulo="mensajes.titulo2" :subtitulo="mensajes.subtitulo" icono="mdi-bookshelf">
            ...
            <v-window v-model="step" class="h-auto w-100">
                ...
                <v-window-item :value="3">
                    <v-sheet v-if="step === 3">
                        ...
                        ></TipoCursoForm>
                        <TipoCursoShow v-if="selectedAction == 'show'" :item="selectedItem" :accion="selectedAction"></TipoCursoShow>
                    </v-sheet>
                </v-window-item>
            </v-window>
