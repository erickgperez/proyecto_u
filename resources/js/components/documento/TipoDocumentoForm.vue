...
async function submitForm() {
    ...
    if (valid) {
        try {
            const resp = await axios.post(route('administracion-documento-tipo-save'), formData.value);
...
<template>
    <v-card :title="`${isEditing ? $t('tipoDocumento._editar_') : $t('tipoDocumento._crear_')} `">
