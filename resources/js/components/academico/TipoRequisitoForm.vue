...
async function submitForm() {
    ...
    if (valid) {
        try {
            const resp = await axios.post(route('academico-plan_estudio-tipo_requisito-save'), formData.value);
...
<template>
    <v-card :title="`${isEditing ? $t('tipoRequisito._editar_') : $t('tipoRequisito._crear_')} `">
