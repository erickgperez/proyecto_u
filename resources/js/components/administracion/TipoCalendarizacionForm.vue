...
async function submitForm() {
    ...
    if (valid) {
        try {
            const resp = await axios.post(route('calendarizacion-tipo-save'), formData.value);
...
<template>
    <v-card :title="`${isEditing ? $t('tipoCalendarizacion._editar_') : $t('tipoCalendarizacion._crear_')} `">
