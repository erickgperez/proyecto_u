...
<template>
    <v-alert border="top" type="warning" variant="outlined" prominent v-if="item.solicitud && item.solicitud.etapa.codigo != 'CONFIGURACION'">
        {{ $t('convocatoria._alerta_configuracion_') }}
    </v-alert>
