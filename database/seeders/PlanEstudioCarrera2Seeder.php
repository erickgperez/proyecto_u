...
class PlanEstudioCarrera2Seeder extends Seeder
{
    ...
    public function run(): void
    {
        Carrera::insert([
            ...
            ['codigo' => 'EE-C3', 'nombre' => 'Climatización y Refrigeración', 'tipo_carrera_id' => TipoCarrera::where('codigo', 'CERTIFICACION')->first()->id, 'certificacion_de' => Carrera::where('codigo', 'EE')->first()->id],
